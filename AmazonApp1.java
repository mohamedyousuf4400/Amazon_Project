...
public class AmazonApp  {
	...
	@Test(priority = 6)
	@Parameters ("Search1")
	public void searchBox(String Search1) throws Exception {
			
		WebElement searchBox = driver.findElement(By.id("twotabsearchtextbox"));
		searchBox.sendKeys(Search1 +Keys.ENTER);
		Thread.sleep(2000);
		}
	...
	public void clickTheProduct() throws Exception {
		...
		WebElement clicktheProduct = driver.findElement(By.xpath("//span[text()='1,29,900']"));
		((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView();", clicktheProduct);
		Thread.sleep(2000);
	...
	public void screenShot() throws Exception   {
		...
		File destinationFile = new File("C:\\Users\\lenovo\\Pictures\\amazonCart1.png");
	...
	public void verify() {
		...
		WebElement mobile = driver.findElement(By.xpath("//span[text()='1,29,900.00']"));
